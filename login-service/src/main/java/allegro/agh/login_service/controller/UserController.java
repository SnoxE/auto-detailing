...
//    public ContentDto<CarDto> getUserCars(@org.springframework.web.bind.annotation.PathVariable("userId") String userId) {
...
//            @org.springframework.web.bind.annotation.PathVariable("userId") String userId, @org.springframework.web.bind.annotation.PathVariable("carId") String carId) {
//        carService.deleteCar(Integer.parseInt(userId), Integer.parseInt(carId));
//        return org.springframework.http.ResponseEntity.ok().build();
//    }
//
//    @GetMapping("/{userId}/reservations")
//    public ContentDto<ReservationDto> getUserReservations(@org.springframework.web.bind.annotation.PathVariable("userId") String userId) {
