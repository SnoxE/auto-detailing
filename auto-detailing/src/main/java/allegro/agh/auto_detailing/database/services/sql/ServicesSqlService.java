...
public class ServicesSqlService {
  ...
  public ServicesSqlService(JdbcOperations jdbcOperations) {
    this.jdbcOperations = jdbcOperations;
  }

  private PreparedStatement preparedSelectServiceByNameStatement(
      Connection connection, String serviceName) throws SQLException {
  ...
  private PreparedStatement preparedSelectServiceByNameAndCarSizeStatement(
      Connection connection, String serviceName, String carSize) throws SQLException {
  ...
  private ServiceSqlRow extractServiceRow(ResultSet resultSet)
  ...
  private ServiceNamesSqlRow extractServiceNamesRow(ResultSet resultSet)
      throws SQLException, JsonProcessingException {
    return new ServiceNamesSqlRow(resultSet.getString(ServiceNamesSqlRow.NAME));
  }
}
